...
In order to use the .NET MAUI Community Toolkit you need to install the nuget [package](https://www.nuget.org/packages/CommunityToolkit.Maui) with `dotnet add package CommunityToolkit.Maui` and call the extension method in your `MauiProgram.cs` file as follows:
